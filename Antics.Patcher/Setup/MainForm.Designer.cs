...
namespace Antics.Patcher.Setup
{
    partial class MainForm
    {
        ...
        private void InitializeComponent() {
            ...
            this.toolTipButtons.SetToolTip(this.buttonSetup, "Complete environment setup for working on Antics.SomeLoader source\r\nEquivalent to Decomp" +
        "ile+Patch+SetupDebug\r\nEdit the source in src/Antics.SomeLoader then run Diff Antics.SomeLoader" +
        ...
        "the client binary\r\nOutputs to src/decompiled");
            ...
            this.buttonDiffTerraria.Text = "Diff SomeAntics";
        ...
        "ing decompilation errors\r\n");
            ...
            this.buttonPatchTerraria.Text = "Patch SomeAntics";
        ...
        "source is located in src/Terraria");
            ...
            this.buttonPatchModLoader.Text = "Patch Antics.SomeLoader";
            this.toolTipButtons.SetToolTip(this.buttonPatchModLoader, "Applies Antics.SomeLoader patches to Antics\r\nEdit the source code in src/Antics.SomeLoader af" +
        "ter this phase\r\nInternally formats the SomeAntics sources before patching");
            ...
            this.buttonDiffModLoader.Text = "Diff Antics.SomeLoader";
        ...
        "t to Setup without Decompile");
            ...
            this.hookGenToolStripMenuItem.Text = "HookGen (Disabled)";
            this.hookGenToolStripMenuItem.Enabled = false;
            ...
            this.Name = "MainForm";
            this.Text = "Antics.SomeLoader Dev Setup";
