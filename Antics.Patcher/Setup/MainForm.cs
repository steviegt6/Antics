...
using static Antics.Patcher.Setup.Program;
...
namespace Antics.Patcher.Setup
{
	public partial class MainForm : Form, ITaskInterface
	{
		...
		public MainForm()
		{
			...
			taskButtons[buttonDiffTerraria] = () => new DiffTask(this, "src/decompiled", "src/SomeAntics", "patches/SomeAntics", new ProgramSetting<DateTime>("TerrariaDiffCutoff"));
			taskButtons[buttonPatchTerraria] = () => new PatchTask(this, "src/decompiled", "src/SomeAntics", "patches/SomeAntics", new ProgramSetting<DateTime>("TerrariaDiffCutoff"));
			taskButtons[buttonDiffModLoader] = () => new DiffTask(this, "src/SomeAntics", "src/Antics.SomeLoader", "patches/Antics.SomeLoader", new ProgramSetting<DateTime>("tModLoaderDiffCutoff"));
			taskButtons[buttonPatchModLoader] = () => new PatchTask(this, "src/SomeAntics", "src/Antics.SomeLoader", "patches/Antics.SomeLoader", new ProgramSetting<DateTime>("tModLoaderDiffCutoff"));
